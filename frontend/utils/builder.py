...
compiler_path = (
    "../node_modules/google-closure-compiler/cli.js --js %s --js_output_file %s"
)

# arguments
parser = argparse.ArgumentParser(
    description="Deploy a JS app creating a minifyed version checking for errors."
)
parser.add_argument(
    "input_file", help="the path to the file with a list of all the JS files"
)
...
if os.path.exists(args.input_file) == False:
    sys.stderr.write(
        "\033[91m Error, input file not found: " + args.input_file + "\033[0m\n"
    )
    exit(0)
