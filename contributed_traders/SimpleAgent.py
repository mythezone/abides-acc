                ...
                if bid and ask:
                    ...
                    if len(self.mid_list) > self.window1:
                        self.avg_win1_list.append(
                            pd.Series(self.mid_list)
                            .ewm(span=self.window1)
                            .mean()
                            .values[-1]
                            .round(2)
                        )
                    if len(self.mid_list) > self.window2:
                        self.avg_win2_list.append(
                            pd.Series(self.mid_list)
                            .ewm(span=self.window2)
                            .mean()
                            .values[-1]
                            .round(2)
                        )
                    if (
                        len(self.avg_win1_list) > 0
                        and len(self.avg_win2_list) > 0
                        ...
                        if self.avg_win1_list[-1] >= self.avg_win2_list[-1]:
                            ...
                            if (
                                self.symbol in self.holdings
                                and self.holdings[self.symbol] > 0
                            ):
