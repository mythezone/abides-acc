...
class TestMessage(unittest.TestCase):
    ...
    def test_agent_init(self):
        ...
        for i in range(5):
            Agent(name="TestAgent", type="TestType", random_state=random_state, log_to_file=False)
    ...
    def test_message_init(self):
        ...
        for i in range(5):
            Message(mtype=34, sender=1, recipient=2, send_time=pd.Timestamp('2023-10-01'), content={'key': 'value'})
