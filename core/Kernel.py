...
class Kernel(Singleton):
    ...
    def __init__(
        self, kernel_name: str = None, random_state: np.random.RandomState = None
    ):
        super().__init__()
        ...
        self.kernel_wall_clock_start = pd.Timestamp("now")
    ...
    def runner(
        ...
        if log_dir:
            ...
            self.log_dir = str(int(self.kernel_wall_clock_start.timestamp()))
