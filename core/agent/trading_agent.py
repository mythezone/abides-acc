...
class TradingAgent(Agent, Handler):
    ...
    #             msg.body["symbol"], msg.body["transacted_volume"]
    #         )
    ...
    #     self, symbol, quantity, is_buy_order, order_id=None, ignore_risk=True, tag=None
    # ):
    #     """
    ...
    #     log_print(
    #         "Received last trade price of {} for {}.", self.last_trade[symbol], symbol
    #     )
    ...
    #             log_print(
    #                 "Within {} of {}: {} with {} shares", within, best, price, shares
    #             )
    #             liq += shares
